...
def sendEmail():
    try:
        if request.json['emailId'] is not None:
            ...
            contact_add = "ebinawhite@gmail.com"  ## the email id of the support team
            fromaddr = "ebinawhite@gmail.com"   ## the email id from where we are going to send the mail
            ...
            # Authentication
            s.login(fromaddr,"ebina@17041993") # give your password here
